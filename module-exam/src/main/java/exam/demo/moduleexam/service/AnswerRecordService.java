...
public interface AnswerRecordService extends IService<AnswerRecord> {
     ...
     * @date: 2021-12-10
     */
    AnswerRecord getOneByPaperSubjectIdAndExamRecordId(String paperSubjectId, String examRecordId);
     ...
     * @date: 2021-12-10
     */
    List<AnswerRecord> getListByExamRecordId(String examRecordId);
}
